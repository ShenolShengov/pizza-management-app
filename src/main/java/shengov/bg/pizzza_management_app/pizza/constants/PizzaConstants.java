...
public final class PizzaConstants {
    ...
    public static final String NAME_SIZE =
            "Pizza name must be between 3 and 40 characters";

    public static final String DESCRIPTION_SIZE =
            "Description cannot exceed 200 characters";

    public static final String INGREDIENTS_REQUIRED =
            "Pizza must have at least one ingredient";

    public static final String SIZES_REQUIRED =
            "Pizza must have at least one size";

    public static final String SIZE_ID_REQUIRED =
            "Size ID is required";
